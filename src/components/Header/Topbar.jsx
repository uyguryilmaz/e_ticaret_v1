...
const Topbar = () => {
  ...
  return (
    <div className=" flex  justify-center md:justify-between items-center  shadow">
          ...
          <AnimatePresence>
            {dillerAcikMi && (
              <motion.div
                ...
                className="absolute top-full left-0 border border-gray-200 rounded w-full flex flex-col"
              >
                <span
          ...
          <AnimatePresence>
            {paralarAcikMi && (
              <motion.div
                ...
                animate={{ scale: 1, opacity: 1 }}
                exit={{ scale: 0, opacity: 0 }}
                className="absolute top-full right-1 border border-gray-200 rounded w-full flex flex-col"
              >
                <span
                  onClick={() => paraSec("TRY")}
                  className="px-2 py-1.5 flex gap-2 justify-start items-center"
